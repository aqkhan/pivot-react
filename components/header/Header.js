      ...
      <div className="hidden lg:flex w-full f-f-p justify-between items-center py-6 relative">
        <div className="w-2/3">
          <svg xmlns="http://www.w3.org/2000/svg" width={115} height={40} viewBox="0 0 115 40" fill="none">
            ...
            <path d="M71.292 25.8219C71.292 22.2603 73.8994 19.6575 77.536 19.6575C81.1726 19.6575 83.78 22.2603 83.78 25.8219C83.78 29.3836 81.1726 31.9863 77.536 31.9863C73.968 31.9863 71.292 29.3836 71.292 25.8219ZM82.2019 25.8904C82.2019 23.3562 80.4179 21.4384 77.6732 21.4384C74.9286 21.4384 73.1446 23.3562 73.1446 25.8904C73.1446 28.4247 74.9286 30.3425 77.6732 30.3425C80.4179 30.3425 82.2019 28.4247 82.2019 25.8904ZM82.9567 25.8219C82.9567 22.9452 80.8296 20.7534 77.6046 20.7534C74.3797 20.7534 72.3212 22.9452 72.3212 25.8219C72.3212 28.6986 74.3797 30.8904 77.6046 30.8904C80.8296 30.8219 82.9567 28.6986 82.9567 25.8219Z" fill="#032E47" />
            <path d="M101.139 39.4521V17.1918H93.1113V12.0548H115V17.1918H107.04V39.4521H101.139Z" fill="#032E47" />
            <path d="M77.3628 27.9299C76.7582 27.8666 76.3071 27.6132 76 27.2649L76.4415 26.5893C76.6526 26.8321 76.9693 27.0537 77.3532 27.1382V26.1353C76.7678 25.9664 76.1248 25.7236 76.1248 24.858C76.1248 24.214 76.5854 23.6756 77.3628 23.5806V23H77.9098V23.6017C78.3704 23.6545 78.7639 23.8551 79.071 24.1612L78.62 24.8157C78.4088 24.6046 78.1689 24.4779 77.9098 24.404V25.3013C78.5048 25.4702 79.167 25.7236 79.167 26.5787C79.167 27.286 78.7543 27.8244 77.9098 27.9194V28.5H77.3628V27.9299ZM77.3628 25.143V24.3724C77.1036 24.4146 76.9597 24.5729 76.9597 24.7841C76.9597 24.9741 77.1132 25.0691 77.3628 25.143ZM77.9098 26.2831V27.1276C78.1881 27.0643 78.3321 26.8848 78.3321 26.6843C78.3321 26.4731 78.1497 26.3676 77.9098 26.2831Z" fill="#4B98D3" />
          </svg>
        </div>
        <div className="md:w-1/2 xl:w-1/3">
          <ul className="flex justify-between w-full items-center text-gray-600">
            <li className="border-custom pb-1"><a href>Home</a></li>
            <li className="border-custom-trans pb-1"><a href>Stats</a></li>
            <li className="border-custom-trans pb-1"><a href>Coins</a></li>
            <li className="border-custom-trans pb-1"><a href>Blog</a></li>
            <li className="border-custom-trans pb-1"><a href>Contact Us</a></li>
          </ul>
        </div>
      </div>
    </nav>
    <nav className="lg:hidden">
      <div className="flex py-6 justify-between items-center px-4">
        ...
        <div className="visible flex items-center">
          <ul  className={` ${show ? 'hidden': 'block' }  p-2 border-r bg-white absolute rounded top-0 left-0 right-0 shadow mt-16 md:mt-16`}>
          ...
          <div className="xl:hidden">
            <svg  onClick={()=> setShow(!show)} aria-haspopup="true" aria-label="Main Menu" xmlns="http://www.w3.org/2000/svg" className="show-m-menu icon icon-tabler icon-tabler-menu" width={28} height={28} viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" fill="none" strokeLinecap="round" strokeLinejoin="round">
              <path stroke="none" d="M0 0h24v24H0z" />
              <line x1={4} y1={8} x2={20} y2={8} />
              <line x1={4} y1={16} x2={20} y2={16} />
            </svg>
            <div  className="hidden close-m-menu" onClick={() =>setShow(show)}>
